...
Interpreta las siguientes siglas según su significado institucional en el
...
Estas equivalencias son únicamente ayudas para interpretar el texto. La
presencia de una sigla o de la institución correspondiente no constituye por sí
misma una justificación normativa ni activa automáticamente ningún código.
Aplica los criterios de `ALCANCE` y las definiciones del libro de códigos a la
