...
- Si el mismo span satisface más de un concepto, emite una anotación ordinaria
  para cada concepto y aplica a cada una las mismas reglas de criterio,
  orientación y justificación. Nunca repitas el mismo span y concepto.
