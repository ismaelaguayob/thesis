...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Directory for SVG, PNG, and synthetic stance matrix outputs.",
    )
...
def main() -> None:
    ...
    svg_path = args.output_dir / "synthetic_signed_discourse_network.svg"
    png_path = args.output_dir / "synthetic_signed_discourse_network.png"
    matrix_path = args.output_dir / "synthetic_actor_concept_matrix.csv"
