...
external_speakers_dict = ministers | dict_session_12 | dict_session_24
...
candidates_full = collect_unlabeled_speaker_candidates(data_normalized_full)
```
...
Por último, podemos aplanar el dataframe con todas las intervenciones discursivas para que nos sirva en el análisis.
