...
from bcn_scraper.akoma_speech import add_speech_content

data = pd.read_csv("data/datos_bcn_akn.csv", sep = ";")

data_speech = add_speech_content(data, as_json = True)

data_speech.to_json("data/datos_bcn_akn_speech.json", orient="records", force_ascii=False, indent=4)

dic_12 = data_speech["speech_content"][11]
```
