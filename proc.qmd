...
corpus_manifest = pd.read_csv("data/corpus_manifest.csv")
...
data_analysis.to_parquet("data/corpus_sala.parquet", index=False)
data_message.to_parquet("data/corpus_mensaje_inicial.parquet", index=False)
```
...
speaker_identity_audit.to_parquet("data/speaker_identity_audit.parquet", index=False)
speaker_identity_audit.to_csv("data/speaker_identity_audit.csv", index=False)
...
candidates_full.to_parquet("data/speaker_candidates.parquet", index=False)
candidates_pending.to_parquet("data/speaker_candidates_pending.parquet", index=False)
candidate_progress.to_csv("data/speaker_candidate_progress.csv", index=False)
...
missing_speaker_refs.to_parquet("data/parliamentarian_identity_gaps.parquet", index=False)
missing_speaker_refs.to_csv("data/parliamentarian_identity_gaps.csv", index=False)
...
speech_df.to_parquet("data/speech_df.parquet", index=False)
speech_df_full.to_parquet("data/speech_df_full.parquet", index=False)
speech_quality_report.to_parquet("data/speech_quality_report.parquet", index=False)
speech_quality_report.to_csv("data/speech_quality_report.csv", index=False)
