...
p. 293-468 requerimiento de inconstitucionalidad:
- 15 de enero de 2025: Se recibió el [Oficio N° 312-372 del Presidente de la República](data/informes/indicaciones_presidente.pdf), que formuló 176 páginas de indicaciones al proyecto.
...
import pyarrow
import pandas as pd
from bcn_scraper import add_speech_content, normalize_speech_content, collect_unlabeled_speaker_candidates
...
data_normalized.to_parquet("data/datos_normalizados.parquet", index=False)
