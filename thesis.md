...
La pregunta de investigación es: ¿cómo se articulan las economías morales en disputa en los debates legislativos previsionales chilenos de 2022–2025 y en qué medida el repertorio asociado a la capitalización individual mantiene su centralidad y alcanza a actores reformistas? La investigación comienza evaluando la existencia de dos polos discursivos vinculados a la justicia de mercado y a la justicia política (H1a), así como el rol de intermediación de actores de centroizquierda (H1b). Luego, compara la centralidad y el alcance de los conceptos entre los tres proyectos (H2), y examina su persistencia durante la reforma de la Ley N.º 21.735 (H3) y la ampliación del apoyo al repertorio de capitalización individual entre actores inicialmente reformistas (H4).

El estudio aplica análisis de redes discursivas (Leifeld, 2017, 2020\) a los tres procesos legislativos, con codificación asistida por grandes modelos de lenguaje (LLM), validación manual y lectura de argumentos (Hayes, 2025). Primero, se identifican coaliciones y conceptos centrales en el debate legislativo; luego, se compara el apoyo a estos entre proyectos de ley mediante modelos logísticos; finalmente, se examina la persistencia y difusión del repertorio de capitalización individual durante la reforma. Con ello, el estudio realiza tres contribuciones: 1\) aporta evidencia sobre las concepciones de justicia que organizan el conflicto previsional chileno; 2\) vincula el estudio de las economías morales con el análisis relacional de coaliciones y repertorios normativos; y 3\) propone una metodología cualitativa-computacional de codificación asistida por inteligencia artificial e interpretación sociológica para analizar la deliberación legislativa.
...
* *H1b. Intermediación:* Los actores de centroizquierda y el criterio de necesidad material ocuparán posiciones de mayor intermediación entre los polos al combinar justificaciones/actores de ambos repertorios.
...
| H3. Persistencia | Fases de la Ley N.º 21.735 | Cobertura de apoyo, balance entre apoyo y rechazo, centralidad relativa y conexiones de cada componente de la economía moral. |
