...
**Economías morales y coaliciones discursivas en el debate previsional chileno**
...
[**2\. Persistencia ideacional y estructuración discursiva	11**](#2.-persistencia-ideacional-y-estructuración-discursiva)

[2.1. Persistencia ideacional y el rol de las ideas	11](#2.1.-persistencia-ideacional-y-el-rol-de-las-ideas)

[2.2 Las coaliciones discursivas y la hegemonía	12](#2.2-las-coaliciones-discursivas-y-la-hegemonía)

[**3\. El debate previsional chileno: polos discursivos y actores mediadores	15**](#3.-el-debate-previsional-chileno:-polos-discursivos-y-actores-mediadores)

[**4\. Metodología	18**](#4.-metodología)

[4.1 Datos	18](#4.1-datos)

[4.2 Variables	19](#4.2-variables)

[4.3 Estrategia de análisis	20](#4.3-estrategia-de-análisis)
...
Hasta ahora, las investigaciones sobre pensiones en Chile se han enfocado en el diseño institucional y la trayectoria política del sistema (Borzutzky, 2005, 2019; Mesa-Lago & Bertranou, 2016), sus resultados financieros y tasas de reemplazo (Benavides & Valdés, 2018; Larrañaga, 2024), las brechas socioeconómicas y de género (Parada-Contzen, 2023), las movilizaciones sociales contra las AFP (López-González & Vélez-Maya, 2025; Rozas & Maillet, 2019), las preferencias ciudadanas sobre diseños previsionales y administración de fondos (Domínguez, 2017; Parada-Contzen & Sanhueza, 2025), las actitudes frente a la justicia de mercado y el mérito previsional (Castillo et al., 2019, 2025, 2026), y los discursos mediáticos o expertos en torno a la reforma (Campos-Rojas & González-Arias, 2022; González Arias & Campos Rojas, 2020). Esta literatura ha mostrado que la crítica a las bajas pensiones convive con una adhesión persistente a criterios meritocráticos y contributivos, especialmente en torno a la propiedad de los fondos y al vínculo entre la cotización individual y el beneficio futuro (Castillo et al., 2019; Kay & Borzutzky, 2022). Sin embargo, se sabe menos sobre cómo estos principios de justicia se articulan en el debate legislativo, cómo se forman coaliciones discursivas en torno a ellos y qué repertorios mantienen su centralidad o se extienden hacia actores reformistas. El presente estudio aborda esa brecha analizando el debate parlamentario de las últimas reformas previsionales chilenas como un espacio privilegiado para observar la disputa por la hegemonía discursiva.

El argumento del estudio es que la economía moral de la capitalización individual puede persistir en el debate mediante la centralidad de las justificaciones que la sostienen y su reconocimiento por actores que impulsan reformas. La perspectiva de las economías morales permite examinar las combinaciones de principios distributivos que fundamentan el apoyo a los mercados y a la protección colectiva (Fourcade & Healy, 2007; Koos & Sachweh, 2019). En el caso previsional, interesa observar cómo la propiedad individual y el autofinanciamiento se articulan con la reciprocidad contributiva, las restricciones de gasto y las justificaciones de la organización privada y mercantil de la previsión, así como su relación con la igualdad, la solidaridad intergeneracional y la necesidad. Su persistencia discursiva se examina a través de la *estructuración*: la capacidad de un repertorio para establecer categorías y premisas que otros actores reconocen al formular sus propuestas (Hajer, 1997). Estos resultados aportan a la discusión sobre robustez ideacional, entendida como la conservación de una orientación mediante ajustes ante cambios del entorno (Migone et al., 2024).

La pregunta de investigación es: ¿cómo se articulan las economías morales en disputa en los debates legislativos previsionales chilenos de 2022–2025 y en qué medida el repertorio asociado a la capitalización individual mantiene su centralidad y alcanza a actores reformistas? La investigación parte de una hipótesis sobre dos polos discursivos vinculados con la justicia de mercado y la justicia política (H1a) y de una expectativa de intermediación de actores de centroizquierda (H1b). Compara luego la centralidad y el alcance de los conceptos entre los tres proyectos (H2), y examina su persistencia durante la reforma de la Ley N.º 21.735 (H3) y la ampliación del apoyo al repertorio de capitalización individual entre actores inicialmente reformistas (H4). La distinción entre polos se apoya en las combinaciones de criterios distributivos, con igualdad o universalismo y solidaridad intergeneracional como referentes esperados de la transformación, y necesidad material como justificación potencialmente compartida.

Para abordar estas hipótesis se utiliza análisis de redes discursivas (Leifeld, 2017, 2020), combinando codificación cualitativa asistida por grandes modelos de lenguaje (LLM), validación manual y lectura dirigida de argumentos (Hayes, 2025). Las redes permiten identificar coaliciones y conceptos centrales; las frecuencias y la cobertura de actores permiten comparar su presencia y alcance. Modelos logísticos con intercepto por actor complementan la comparación entre proyectos mediante probabilidades de apoyo a los conceptos. La creación de la PGU, la ampliación de su focalización y la reforma de la Ley N.º 21.735 se analizan como procesos separados. Dentro de esta última, la comparación de los debates de la Cámara en 2024 y 2025 permite observar a actores que participan en ambos momentos. El estudio contribuye así a comprender qué concepciones de justicia organizan el conflicto previsional, cómo se relacionan sus coaliciones y qué fundamentos del modelo conservan presencia y centralidad a través de debates con distintos objetos de reforma.
...
En términos históricos, el panorama discursivo sugiere dos polos principales. Un polo de preservación vincula la propiedad individual, la reciprocidad contributiva entre cotización y beneficio, la capitalización y la administración privada. Un polo de transformación articula la igualdad o el universalismo, la solidaridad intergeneracional y una mayor responsabilidad colectiva en la protección previsional. La necesidad material puede ser invocada por ambos polos para justificar respuestas distributivas diferentes. La trayectoria de la centroizquierda permite esperar que algunos de sus actores conecten ambos polos al combinar solidaridad con contribución, focalización y restricciones de viabilidad.

La operacionalización distingue los criterios de merecimiento, los criterios contextuales y las justificaciones específicas del caso. Junto con CARIN, se incorporan la *igualdad o el universalismo* y la *conciencia de costos* identificados por Laenen et al. (2019). La primera categoría recoge las razones que fundamentan una protección igualitaria o universal; la segunda se delimita, para este estudio, a los argumentos que afirman o refutan restricciones de gasto y financiamiento de una reforma. La solidaridad se desagrega según la justificación expresada: una apelación al derecho igual de protección corresponde a igualdad o universalismo, mientras una defensa de la transferencia de recursos o de la distribución de riesgos entre generaciones corresponde a *solidaridad intergeneracional*. La *propiedad individual de los fondos* y la *capitalización individual* conservan su especificidad como fundamentos del arreglo previsional chileno (Alemparte, 2025). La dimensión institucional se recoge mediante *previsión como mercado*, que incluye justificaciones y críticas de la competencia, la administración privada y los incentivos, e *ineficiencia y riesgo estatal*, que registra razones para excluir o limitar la administración estatal y sus refutaciones. Estas distinciones permiten analizar las combinaciones de razones que sostienen cada posición. La reciprocidad contributiva y la conciencia de costos se interpretarán según los arreglos distributivos que justifican y su articulación con los demás conceptos.

La comparación entre proyectos permite examinar cómo cambia la relevancia de estos principios según el objeto de la deliberación. La creación de la PGU y la ampliación de su focalización concentran la discusión en el acceso a una prestación no contributiva; la reforma de la Ley N.º 21.735 incorpora, además, disputas sobre el destino de las cotizaciones y la organización de la previsión. Sobre esta base se formulan las siguientes hipótesis:

* *H1a. Coaliciones:* En el debate de la Ley N.º 21.735 se identificarán dos polos discursivos principales, vinculados con la justicia de mercado y la justicia política. El polo de preservación articulará propiedad y capitalización individual con reciprocidad contributiva, conciencia de costos y justificaciones de la organización privada y mercantil de la previsión. El polo de transformación se distinguirá por su apoyo a la igualdad o el universalismo y a la solidaridad intergeneracional. La necesidad material podrá ser compartida por ambos polos.

* *H1b. Intermediación:* Los actores de centroizquierda ocuparán posiciones de mayor intermediación entre los polos al combinar justificaciones de ambos repertorios.

* *H2. Comparación entre proyectos:* La propiedad individual, la capitalización individual y la previsión como mercado tendrán mayor presencia y centralidad relativa en el debate de la Ley N.º 21.735 que en cada uno de los debates de PGU. En estos últimos, la necesidad material y la igualdad o el universalismo alcanzarán un apoyo más transversal entre grupos políticos.

* *H3. Persistencia:* Durante las fases observadas de la Ley N.º 21.735, el repertorio asociado a la capitalización individual mantendrá su cobertura de apoyo entre actores y su centralidad relativa en la red de conceptos. Se examinarán por separado propiedad individual, capitalización individual, reciprocidad contributiva, conciencia de costos, ineficiencia y riesgo estatal, y previsión como mercado, así como las relaciones que los articulan.
...
El análisis combina la identificación de coaliciones, la comparación entre proyectos y el seguimiento de los repertorios durante la reforma. La correspondencia entre hipótesis, unidades de comparación y medidas se resume en la Tabla 2.

**Tabla 2.** *Hipótesis y estrategia de contrastación*

| Hipótesis | Comparación | Medidas y evidencia |
| :---- | :---- | :---- |
| H1a. Coaliciones | Agrupamientos de actores en la Ley N.º 21.735 | Congruencia y conflicto normalizados; cobertura de apoyo y rechazo por concepto en cada coalición; lectura de sus argumentos distintivos. |
| H1b. Intermediación | Actores de centroizquierda y demás actores parlamentarios | Centralidad de intermediación en la red de congruencia positiva; vínculos con coaliciones distintas y combinaciones de justificaciones en sus intervenciones. |
| H2. Proyectos | Leyes N.º 21.419, 21.538 y 21.735 por separado | Proporción de intervenciones con apoyo o rechazo; cobertura por grupo político; centralidad relativa; probabilidades de apoyo estimadas con modelos logísticos. |
| H3. Persistencia | Fases de la Ley N.º 21.735 | Cobertura de apoyo, balance entre apoyo y rechazo, centralidad relativa y conexiones de cada componente del repertorio. |
| H4. Difusión | Actores inicialmente reformistas presentes en la Cámara en 2024 y 2025 | Cambios en la proporción que respalda cada concepto; trayectorias de postura y pasajes que evidencian aceptación o reconocimiento de sus premisas. |

La descripción inicial distinguirá la frecuencia de las declaraciones de su extensión entre intervenciones y actores. Para cada concepto y postura se calculará el porcentaje de intervenciones con al menos una declaración correspondiente y la proporción de actores que la expresan. Las reiteraciones dentro de una intervención contarán una sola vez en la primera medida, y cada actor contará una sola vez por concepto y postura en cada ventana de análisis. Los denominadores serán, respectivamente, las intervenciones conservadas para codificación y los actores que participan en ellas. El apoyo y el rechazo se informarán por separado; la ausencia de una declaración se interpretará como falta de expresión observada.

Para H1a, la red bipartita de actores y conceptos se proyectará en redes de congruencia y conflicto. Se utilizará el conjunto del libro de códigos, conservando las posturas de apoyo y rechazo como relaciones distintas. Dos actores serán congruentes cuando expresen la misma orientación ante un concepto y estarán en conflicto cuando expresen orientaciones opuestas. Los vínculos se normalizarán según la amplitud de sus repertorios para reducir el efecto de la actividad desigual (Leifeld, 2017). Sobre la red con vínculos positivos y negativos se aplicará detección de comunidades mediante *signed spin-glass*, con repetición de las estimaciones para examinar la estabilidad de los agrupamientos (Schaub, 2021). El número de comunidades se estimará sin fijarlo en dos. La hipótesis se evaluará atendiendo tanto a la organización en polos como a su contenido: qué conceptos y posturas son compartidos dentro de cada grupo y cuáles los distinguen. La bipolarización favorecida por la codificación de posiciones opuestas se tendrá en cuenta al interpretar la existencia de dos polos (Leifeld, 2017).

H1b se examinará mediante la centralidad de intermediación de los actores parlamentarios, o *betweenness centrality* (Freeman, 1977), calculada sobre los vínculos de congruencia positiva. Los pesos de semejanza se convertirán en distancias mediante su inverso; los vínculos de conflicto se analizarán por separado. Se comparará la distribución de esta medida entre centroizquierda y los demás grupos políticos, según su afiliación al momento del debate. La interpretación de intermediación se apoyará también en la presencia de vínculos con distintas coaliciones y en intervenciones que combinen argumentos de ambos repertorios.

La centralidad conceptual se examinará en una proyección de la red de actores y conceptos-postura. Cada vínculo indicará en qué medida dos conceptos-postura son expresados por los mismos actores dentro de una ventana; se normalizará mediante la similitud de Jaccard entre sus conjuntos de actores (Leifeld, 2017). Se calculará la fuerza de cada nodo, como suma de sus vínculos normalizados, y se comparará su posición relativa entre conceptos. Se conservará el mismo universo de conceptos-postura en todas las ventanas, incluidos los ausentes, para mantener una base común de comparación. Esta red identifica proximidad entre repertorios; la relación argumental entre conceptos se comprobará en las intervenciones que sostienen los vínculos relevantes.

Para H2, se compararán separadamente los perfiles de las tres leyes. La mayor presencia de propiedad, capitalización y previsión como mercado se evaluará mediante las proporciones de intervenciones que los expresan, distinguiendo apoyo y rechazo. Su centralidad se contrastará mediante las posiciones relativas en cada red. El alcance transversal de necesidad e igualdad o universalismo se examinará a través de la cobertura de apoyo en distintos grupos políticos. Como complemento, se estimarán modelos logísticos por concepto cuya variable dependiente indique si una intervención contiene al menos una declaración de apoyo. Los predictores serán la ley, el grupo político y su interacción, incorporando cámara, tipo de actor y longitud de la intervención como ajustes. Un intercepto aleatorio por actor recogerá la repetición de intervenciones. Se informarán probabilidades predichas y diferencias entre proyectos y grupos, con su incertidumbre. Estas estimaciones describen asociaciones entre los episodios observados; las intervenciones de una misma ley comparten un contexto legislativo y no constituyen reformas independientes.

H3 se aplicará a los seis conceptos definidos en la hipótesis, manteniéndolos como unidades separadas. Se distinguirán las discusiones de primer trámite en la Cámara de enero de 2024, el segundo trámite en el Senado de enero de 2025 y el tercer trámite en la Cámara de enero de 2025. En cada ventana se examinarán la cobertura de apoyo, el balance entre apoyo y rechazo y la centralidad relativa de cada componente. Se observará también si reciprocidad, conciencia de costos y las justificaciones institucionales permanecen vinculadas con propiedad y capitalización individual. La interpretación de persistencia considerará la magnitud y dirección de los cambios; la falta de una diferencia estadísticamente significativa no se tomará como prueba de estabilidad. La comparación entre cámaras describe configuraciones del debate, mientras el seguimiento de los mismos actores en la Cámara permite examinar continuidad individual.

Para H4, los actores inicialmente reformistas se identificarán a partir de su alineación con el repertorio de transformación en las discusiones de la Cámara de enero de 2024. Su pertenencia inicial se mantendrá fija para seguir su trayectoria, con independencia de posteriores cambios de coalición. Entre quienes también intervienen en enero de 2025 se comparará la proporción que respalda cada concepto del repertorio de capitalización individual. Se distinguirán apoyo presente desde el inicio, aparición posterior de apoyo y cambio explícito de rechazo a apoyo. La lectura de los pasajes correspondientes permitirá examinar si se acepta una premisa antes cuestionada o se modifica una propuesta para satisfacerla. El apoyo compartido desde la primera ventana se interpretará como alcance transversal previo; la aparición posterior de una declaración documentará ampliación del repertorio expresado, sin asumir por sí sola un cambio de creencia o transmisión entre actores (Leifeld, 2013).

La estructuración se interpretará mediante la convergencia de los resultados de H1a–H4 y una lectura dirigida de los argumentos. Se seleccionarán intervenciones que sostengan los conceptos centrales, los vínculos entre coaliciones y las trayectorias de apoyo observadas, junto con casos que contradigan esos patrones. El predominio de un repertorio requerirá evidencia de que sus premisas son reconocidas o condicionan propuestas de actores rivales. La frecuencia de menciones o rechazos puede revelar controversia, y se distinguirá de la aceptación de un criterio distributivo. Las conexiones de reciprocidad o restricciones de gasto con otros conceptos se interpretarán según el arreglo que justifican. Esta lectura permitirá discutir qué economías morales organizan el debate y qué evidencia aportan su persistencia y alcance a la discusión sobre robustez ideacional.
