...
El estudio aplica análisis de redes discursivas (Leifeld, 2017, 2020) a los tres procesos legislativos, con codificación asistida por grandes modelos de lenguaje (LLM), validación manual y lectura de argumentos (Hayes, 2025). Identifica coaliciones y conceptos centrales, compara el apoyo a estos entre proyectos mediante modelos logísticos y examina la persistencia y difusión del repertorio de capitalización individual durante la reforma. Con ello, aporta evidencia sobre las concepciones de justicia que organizan el conflicto previsional chileno y vincula el estudio de las economías morales con el análisis relacional de coaliciones y repertorios normativos. En términos metodológicos, integra codificación asistida por inteligencia artificial e interpretación sociológica para analizar la deliberación legislativa.
