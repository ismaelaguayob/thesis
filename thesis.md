...
[**1\. La dimensión moral y normativa en el debate previsional	7**](#1.-la-dimensión-moral-y-normativa-en-el-debate-previsional)

[1.1. Justicia de mercado vs. Justicia política: Los mercados como economías morales	7](#1.1.-justicia-de-mercado-vs.-justicia-política:-los-mercados-como-economías-morales)
...
[**4\. Metodología	17**](#4.-metodología)

[4.1 Datos	17](#4.1-datos)

[4.2 Variables	18](#4.2-variables)

[4.3 Estrategia de análisis	19](#4.3-estrategia-de-análisis)
...
La pregunta de investigación es: ¿cómo se articulan las economías morales en disputa en los debates legislativos previsionales chilenos de 2022–2025 y en qué medida el repertorio asociado a la capitalización individual mantiene su centralidad y alcanza a actores reformistas? La investigación comienza evaluando la existencia de dos polos discursivos vinculados a la justicia de mercado y a la justicia política (H1a), así como el rol de intermediación de actores de centroizquierda y del criterio de necesidad material (H1b). Luego, compara la centralidad y el alcance de los conceptos entre los tres proyectos (H2), y examina su persistencia durante la reforma de la Ley N.º 21.735 (H3) y la ampliación del apoyo al repertorio de capitalización individual entre actores inicialmente reformistas (H4).
...
El presente manuscrito se organiza de la siguiente manera. Las secciones 1 a 3 desarrollan los antecedentes conceptuales y empíricos y derivan las expectativas del estudio. La sección 4 detalla los datos, las variables y la estrategia de análisis. La sección 5 presenta los resultados del estudio. Por último, las secciones 5 y 6 abordan la discusión con la literatura especializada y las principales limitaciones y propuestas de próximos estudios, respectivamente.
...
* *H1b. Intermediación:* Los actores de centroizquierda ocuparán posiciones de mayor intermediación entre los polos al combinar justificaciones de ambos repertorios. El criterio de necesidad material actuará como puente entre los repertorios conceptuales de ambas coaliciones.

* *H2. Comparación entre proyectos:* Los conceptos relacionados con la justicia de mercado y la capitalización individual tendrán mayor presencia y centralidad relativa en el debate de la Ley N.º 21.735 que en cada uno de los debates de PGU. En estos últimos, la necesidad material y la igualdad o el universalismo alcanzarán un apoyo más transversal entre grupos políticos.
...
El análisis se desarrollará en siete pasos: descripción de las declaraciones, detección de coaliciones, construcción de redes de conceptos, examen de la intermediación, comparación entre proyectos, seguimiento de la persistencia y evaluación de la difusión. La Tabla 2 vincula cada hipótesis con las medidas correspondientes.

**Tabla 2.** *Hipótesis y estrategia de contrastación*

| Hipótesis | Comparación | Medidas y evidencia |
| :---- | :---- | :---- |
| H1a. Coaliciones | Agrupamientos de actores en la Ley N.º 21.735 | Detección de comunidades en la red de congruencia y conflicto; conceptos y posturas distintivos de cada coalición. |
| H1b. Intermediación | Actores de centroizquierda frente a los demás actores parlamentarios; necesidad material frente a los demás conceptos | Centralidad de intermediación de actores y conceptos en sus respectivas redes de congruencia; conexiones entre polos y lectura de argumentos compartidos. |
| H2. Proyectos | Leyes N.º 21.419, 21.538 y 21.735 por separado | Presencia y centralidad de los seis conceptos del repertorio de capitalización individual; cobertura de apoyo a necesidad e igualdad/universalismo por grupo político; probabilidades estimadas mediante modelos logísticos. |
| H3. Persistencia | Fases de la Ley N.º 21.735 | Continuidad de la presencia, cobertura de apoyo, balance de posturas y centralidad de cada componente de la economía moral. |
| H4. Difusión | Actores inicialmente reformistas presentes en la Cámara en 2024 y 2025 | Cambios en el apoyo observado a cada concepto y lectura de los argumentos que sustentan esas trayectorias. |

En primer lugar, se describirán las declaraciones según concepto, postura, actor, ley y fase legislativa. Para calcular la presencia de cada concepto, las menciones repetidas dentro de una intervención contarán una sola vez. En la descripción de posturas se conservará un registro por combinación de intervención, concepto y orientación, de modo que una intervención pueda contener tanto apoyo como rechazo. Las participaciones posteriores de un mismo actor se contabilizarán por separado, tanto dentro de una fase como entre fases. Los porcentajes utilizarán como denominador las intervenciones conservadas para codificación en la ley o fase correspondiente. La cobertura de actores complementará estos conteos: indicará qué proporción de los participantes respalda o rechaza cada concepto en cada fase. Este indicador describe la extensión de una postura entre personas y conserva las intervenciones repetidas en la base y en los análisis de frecuencia. La ausencia de una declaración se interpretará como falta de expresión observada.

En segundo lugar, se identificarán las coaliciones para evaluar H1a. La red bipartita registrará cuántas intervenciones de cada actor contienen apoyo o rechazo a cada concepto. Su proyección conectará a los actores por la semejanza de sus repertorios: las coincidencias de postura producirán vínculos de congruencia y las posiciones opuestas producirán vínculos de conflicto (Leifeld, 2017). Se normalizarán ambas relaciones por el volumen de los perfiles de los actores mediante similitud coseno, conservando la frecuencia de sus intervenciones. La diferencia entre congruencia y conflicto dará lugar a una red ponderada con vínculos positivos y negativos. Sobre ella se aplicará detección de comunidades mediante *signed spin-glass*, repitiendo las estimaciones para examinar la estabilidad de los agrupamientos (Schaub, 2021). El procedimiento determinará el número de comunidades sin fijarlo en dos. Se contrastará H1a a partir de la organización de los grupos y de los conceptos y posturas que los distinguen, interpretando sus repertorios en relación con la justicia de mercado y la justicia política.

En tercer lugar, se construirán dos redes de conceptos con funciones distintas. La red de presencia conceptual reunirá las intervenciones que mencionan cada concepto, con independencia de su postura, y conectará los conceptos utilizados por los mismos actores. Los perfiles conservarán el número de intervenciones de cada actor y los vínculos se normalizarán mediante similitud coseno. La fuerza de cada nodo, calculada como la suma de sus vínculos normalizados, indicará su centralidad relacional. Un concepto podrá ocupar una posición central por recibir apoyo, por ser cuestionado o por suscitar ambas posiciones. La distribución de posturas permitirá interpretar esa centralidad. Se mantendrá el mismo conjunto de conceptos en todas las ventanas, asignando fuerza cero a los ausentes, para comparar sus posiciones relativas.

La segunda será una red de congruencia conceptual: conectará dos conceptos cuando un mismo actor respalde ambos o rechace ambos, conservando las contribuciones de cada orientación (Leifeld & Haunss, 2012). Los pesos incorporarán la frecuencia de las intervenciones y se normalizarán por el volumen de los perfiles, con la misma regla utilizada para los actores. Esta red servirá para estudiar la intermediación de los conceptos en H1b. Ambas proyecciones describen relaciones entre repertorios de actores; la lectura de las intervenciones comprobará cómo se articulan esos conceptos en los argumentos.

En cuarto lugar, se evaluarán los dos componentes de H1b mediante la centralidad de intermediación, o *betweenness centrality* (Freeman, 1977). En la red de congruencia entre actores se compararán los parlamentarios de centroizquierda con los demás grupos, según su afiliación al momento del debate. En la red de congruencia conceptual se examinará la posición de necesidad material frente a los otros conceptos y sus conexiones con los repertorios característicos de ambos polos. En las dos redes, los pesos positivos se convertirán en distancias mediante su inverso; los vínculos de conflicto se describirán separadamente. La interpretación de intermediación considerará tanto la posición en las rutas entre nodos como la conexión entre repertorios distintos. La lectura dirigida examinará cómo los actores de centroizquierda combinan justificaciones y cómo actores de diferentes coaliciones invocan la necesidad material, distinguiendo sus usos compartidos de sus consecuencias distributivas.

En quinto lugar, se compararán los tres proyectos para evaluar H2. El repertorio asociado a la capitalización individual comprenderá los seis conceptos explicitados en H3: propiedad individual, capitalización individual, reciprocidad contributiva, conciencia de costos, ineficiencia y riesgo estatal, y previsión como mercado. Se contrastarán su porcentaje de presencia en las intervenciones y su centralidad en la red de presencia conceptual de cada ley. La postura se analizará por separado para establecer si ese protagonismo corresponde a respaldo o controversia. El alcance transversal de necesidad e igualdad o universalismo se evaluará mediante la cobertura de apoyo entre los distintos grupos políticos.

Los modelos logísticos complementarán esta comparación a nivel de intervención. Para los conceptos del repertorio de capitalización individual, la variable dependiente indicará su presencia, independientemente de la postura; para necesidad e igualdad o universalismo, indicará la presencia de al menos una declaración de apoyo. Así, cada resultado corresponderá a la expectativa formulada en H2. Los predictores serán la ley, el grupo político y su interacción, con ajustes por cámara, tipo de actor y longitud de la intervención. Un intercepto aleatorio por actor recogerá la dependencia entre sus intervenciones repetidas. Se informarán probabilidades predichas y diferencias entre proyectos y grupos, con su incertidumbre. La comparación se circunscribe a los tres episodios observados; las intervenciones de una misma ley comparten un contexto legislativo.

En sexto lugar, se examinará H3 mediante la comparación de las discusiones de primer trámite en la Cámara de enero de 2024, el segundo trámite en el Senado de enero de 2025 y el tercer trámite en la Cámara de enero de 2025. Cada concepto conservará su identidad en las tres fases. Se observarán su presencia, su cobertura de apoyo, el balance entre apoyo y rechazo y su centralidad relativa en la red de presencia conceptual. Las redes de congruencia mostrarán si reciprocidad, conciencia de costos y las justificaciones institucionales mantienen vínculos con propiedad y capitalización individual. La centralidad sostenida acompañada de rechazo indicará continuidad del concepto como objeto de disputa; la continuidad del respaldo aportará evidencia sobre la persistencia de su aceptación. La evaluación atenderá a la magnitud y dirección de los cambios, sin equiparar la ausencia de significación estadística con estabilidad. La comparación entre cámaras describirá configuraciones del debate y el seguimiento de los participantes comunes de la Cámara aportará evidencia de continuidad individual.

En séptimo lugar, se examinará H4 siguiendo a los actores inicialmente reformistas que intervienen en las discusiones de la Cámara de enero de 2024 y de enero de 2025. Su identificación se basará en la alineación inicial con el repertorio de transformación y se mantendrá fija durante la comparación. Para cada concepto se describirán el apoyo presente desde el comienzo, su aparición posterior y los cambios explícitos de rechazo a apoyo. Se contrastará la proporción de actores de esta cohorte que respalda cada concepto en ambos momentos y se leerán los pasajes que sustentan las diferencias. El apoyo previo se interpretará como alcance transversal inicial; una nueva declaración favorable documentará una ampliación del repertorio expresado, sin establecer por sí sola un cambio de creencia o transmisión entre actores (Leifeld, 2013).

Finalmente, se interpretará la estructuración mediante la lectura conjunta de los patrones de red y de argumentos seleccionados. Se examinarán intervenciones que sustenten los conceptos centrales, las conexiones entre coaliciones y las trayectorias observadas, junto con casos que contradigan esos patrones. La centralidad indicará qué conceptos organizan la discusión; su alcance entre grupos y su papel en la formulación de propuestas mostrarán cómo operan como marcos compartidos. La evidencia de predominio requerirá establecer que los actores rivales reconocen sus premisas o ajustan sus propuestas a ellas. Esta distinción permitirá interpretar las economías morales en disputa y discutir qué aspectos del repertorio de capitalización individual persisten como fundamentos de las propuestas o como objetos de controversia.
