...
[2.3 Las estrategias de legitimación	13](#2.3-las-estrategias-de-legitimación)
...
Esta investigación no se centra en la persistencia institucional de la capitalización individual, es decir, en la continuidad de dicha configuración tras la reforma. En cambio, se estructura en torno a la robustez ideacional de las concepciones que legitiman ese arreglo institucional: la capacidad de las ideas cognitivas y normativas que sustentan el sistema previsional chileno para adaptarse y conservarse en momentos de crisis, ajustando elementos periféricos sin alterar su orientación basal (Migone et al., 2024). El argumento central es que las ideas que legitiman la capitalización individual exhiben robustez ideacional durante la tramitación: conservan su orientación general, se difunden más allá de sus defensores iniciales y se adaptan para incorporar mecanismos solidarios sin abandonar el núcleo del modelo. Este patrón se examinará mediante la *estructuración discursiva* del debate; es decir, observando si esas ideas logran situar sus categorías y su vocabulario como marco compartido, desplazar interpretaciones rivales y delimitar las alternativas consideradas viables (Hajer, 1997).
...
**Tabla 1\.** *Discusiones en Sala e intervenciones del corpus textual*

| Ley | Boletín | Cámara de Diputadas y Diputados | Senado | Total de discusiones | Intervenciones | Fragmentos |
| :---- | :---- | ----: | ----: | ----: | ----: | ----: |
| 21.419 | 14588-13 | 2 | 1 | 3 | 317 |  |
| 21.538 | 15625-13 | 1 | 1 | 2 | 132 |  |
| 21.735 | 15480-13 | 3 | 1 | 4 | 774 |  |
| **Total** |  | **6** | **3** | **9** | **1.223** |  |

*Fuente: elaboración propia a partir de los manifiestos de documentos y las tablas de intervenciones generadas mediante el procesamiento de las Historias de la Ley de la Biblioteca del Congreso Nacional (BCN). Cada discusión corresponde a un documento incorporado al corpus. El conteo de intervenciones antecede a la identificación de declaraciones sustantivas.*

La extracción y normalización se realizaron con una librería de Python desarrollada para recuperar información legislativa, [bcn-scraper](https://github.com/ismaelaguayob/bcn-scraper). El procedimiento utiliza los documentos estructurados en Akoma Ntoso (AKN) \[nota al pie\] y, cuando ese formato no es utilizable, recupera el discurso desde el XML de la Historia de la Ley. Esta segunda vía se aplicó a la discusión del tercer trámite de la Ley N.º 21.735, del 29 de enero de 2025 \[nota al pie\]. La detección de hablantes se realizó con los identificadores estables de los parlamentarios presente en el AKN, y en casos donde no estaba disponible, manualmente con correcciones documentadas de nombres y actores externos. Cada intervención conserva su identificador, documento de origen, fecha, hablante y posición en la secuencia del debate.

El proceso de chunking (describir...).

El corpus a analizar contiene N fragmentos extraídos de 1.223 intervenciones, sumado a 272 eventos de transcripción (como aplausos y manifestaciones) que se mantienen como información contextual. Las intervenciones procedimentales y las nóminas de votación que permanecen dentro de las secciones de discusión se revisan durante la codificación para determinar si contienen declaraciones pertinentes.
...
1. Actores: las personas que emiten la declaración en Sala, incluidos parlamentarios, integrantes del Ejecutivo y autoridades de las cámaras. Se registran su afiliación partidaria, su género y su edad.  
2. Conceptos: representaciones abstractas de los contenidos en discusión que conformarán los nodos conceptuales de la red. El libro de códigos, disponible en el material complementario, se construyó a partir de los criterios CARIN y de categorías justificativas del caso chileno, y se revisó mediante múltiples rondas de calibración manual y en muestras piloto con el LLM.  
...
4. Tiempo: cada declaración se asociará con la ley y la sesión en que fue emitida. Dentro de cada sesión, las intervenciones mantienen el orden en que fueron emitidas.

Adicionalmente, se codificarán las estrategias discursivas empleadas por los actores analizados (Vaara et al., 2006; Van Leeuwen, 2007). Dentro de cada fragmeno se clasificará cada segmento justificativo entre *moralización*, *racionalización*, *narrativización*, *normalización* y *autorización*, pudiendo existir más de una estrategia en cada fragmento. Este procedimiento constituye una etapa separada y no interviene en la construcción de la red de actores y conceptos.
...
Debido al volumen del corpus, un LLM asistirá en la aplicación de un libro de códigos definido teóricamente, manteniendo la interpretación sustantiva a cargo del investigador. En cada fragmento de las intervenciones, primero, se identificarán las declaraciones que se posicionan sobre alguno de los conceptos normativos presentes en el libro de codigos. Después, en esos mismos fragmentos, se detectará la presencia de una o más estrategias de legitimación. El modelo deberá aportar evidencia textual y una justificación de máximo N carácteres para cada decisión. Los casos con evidencia insuficiente, baja confianza reportada por el modelo (\<0.8), dependencia excesiva del contexto o falta de correspondencia con el libro de códigos serán marcados como ambiguos y remitidos a revisión manual (Ashwin et al., 2025; Dunivin, 2025).
