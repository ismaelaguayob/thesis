...
from features.manual_validation.codebook_workbook import (  # noqa: E402
...
def main() -> int:
    ...
    try:
        if args.check:
            ...
            if actual != expected:
                print(
                    "El JSON está desactualizado. Ejecuta "
                    "python -m features.manual_validation.generate_codebook_json.",
                    file=sys.stderr,
                )
                return 1
