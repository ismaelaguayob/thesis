...
DEFAULT_CONFIG_PATH = Path("review-workspace/literature-review.yaml")
...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "paths": {
        "sources_dir": "review-workspace/sources",
        "machine_dir": "review-workspace/machine-readable/markitdown",
        "retrieval_intermediate_dir": "review-workspace/retrieval/intermediate",
        "retrieval_curated_dir": "review-workspace/retrieval/curated",
        "analysis_intermediate_dir": "review-workspace/analysis/intermediate",
        "analysis_curated_dir": "review-workspace/analysis/curated",
        "keyword_ledger": "review-workspace/literature-keywords.yaml",
        "review_state_dir": "review-workspace/review-state",
    },
    "retrieval": {
        "from_year": 2019,
        "to_year": None,
