...
-   Definiciones y conceptualización de CARIN ([@oorschot2000] , [@meuleman2020])
-   Criterios CARIN para la ayuda estatal en los estados de bienestar condicionales o selectivos.
-   **Control** de la situación de neccesidad, ligado al principio de equidad
-   **Actitud** frente a los apoyos estatales
-   **Reciprocidad** o devolución que se da a la sociedad en forma de impuestos o otros aportes
-   **Identidad,** o sea cuanto te pareces a nosotros
-   **Necesidad**, cuanto necesitas el apoyo estatal
-   Evidencia empírica sobre CARIN y pensiones. ¿Qué criterios son más relevantes para justificar distribución estatal en la aseguración de la vejez?

Comúnmente, los mayores se consideran más merecedores de apoyos sociales, debido a no controlar su situación de necesidad (ya que todo el mundo envejece), ya haber contribuído al sistema y ser percibidos como agradecidos [@vanoorschot2006; @meuleman2020]. Debido a esto, se tiende a justificar la universalidad en el acceso a las pensiones en mayores, pero no en el monto de la pensión a recibir, en el cual entra en juego el criterio de control o equidad; dependiendo lo que reciben como pensión de cuanto hayan contribuido o trabajado en su vida laboral [@meuleman2023]. Como evidencia en el contexto chileno, en una encuesta reciente [@institutodeinvestigaciónencienciassociales], un 51% de los encuestados considera que es justo que quienes aportan más al sistema de pensiones reciban mejores pensiones.

En los estudios de la teoría del merecimiento, existe una mucho menor presencia de estudios que apliquen los criterios CARIN desde un enfoque cualitativo, siendo esto tipicamente estudiado a través de encuestas o experimentos de viñetas. Esto ha llevado a destacar la necesidad de utilizar más el análisis cualitativo para estudiar estas temáticas, por las limitaciones que puede traer cerrarse a utilizar solo enfoques cuantitativos [@laenen2019]. Recientemente, ha aumentado el interés académico en utilizar estas metodologías en vinculación con el marco CARIN [eg. @michon2021, @sivis2022, @theiss2023, @summers2025], sin embargo en cuanto al análisis del discurso político en particular hay muy poco desarrollo [hasta el momento se ha encontrado solo @garland2025, de este mismo año], y menos sobre el discurso parlamentario en el desarrollo de reformas. Esto parece especialmente relevante al ser el plano de discusión en donde estos criterios se disputan para llegar o no a consolidarse en políticas específicas, que impactan a posteriori de forma significativa no solo la vida de las personas sino también sus actitudes hacia las políticas distributivas.
