#!/usr/bin/env python3
"""Search Springer Nature OpenAccess API and print normalized JSON."""
...
from search_springer_common import OPENACCESS_URL, search_springer  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        results = [{"source": "springer-openaccess", "query": args.query, "title": None, "error": str(exc)}]
