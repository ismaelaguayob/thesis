...
La literatura ideacional ha mostrado que las ideas influyen en la política social al construir intereses, ofrecer mapas de ruta y legitimar alternativas ante públicos específicos (Béland & Mandelkern, 2024). También ha señalado que ciertos planteamientos sobreviven a las crisis al convertirse en ideas de fondo que delimitan qué alternativas parecen viables, responsables o realistas (Schmidt, 2016). En el contexto previsional chileno, Castiglioni (2018) argumenta que la predominancia de la ideología de mercado entre los tomadores de decisiones ha contribuido a la persistencia de la capitalización individual. Esta persistencia ideacional es crucial para comprender cómo el modelo puede incorporar reformas sin abandonar su orientación distributiva general.

En interacción con los intereses y las instituciones, las ideas contribuyen a volver políticamente defendibles, técnicamente razonables y moralmente aceptables las restricciones al cambio. Al articular esas restricciones con argumentos sobre eficiencia, responsabilidad y justicia, pueden traducir los intereses de la industria y el ordenamiento institucional en preferencias presentadas como objetivas o inevitables (Madariaga, 2020). El presente análisis se centrará empíricamente en la arena discursiva legislativa para identificar las afirmaciones justificativas que estructuran las coaliciones y examinar cuáles conservan su orientación, se adaptan y se difunden durante la tramitación.
...
En esta investigación, se examinará qué estrategias se asocian con distintos tipos de afirmaciones. La reciprocidad contributiva, por ejemplo, es una idea normativa sobre la justicia del monto de una pensión; se convierte en racionalización cuando se invocan sus efectos proyectados para justificar una decisión y en moralización cuando la defensa descansa en el respaldo de expertos o normas. Esta separación permite comparar el *qué* de la disputa con el *cómo* de su presentación pública.

En conjunto, los marcos cumplen funciones analíticas diferenciadas. Las afirmaciones justificativas específicas, incluidas las identificadas utilizando el marco CARIN, y el acuerdo o desacuerdo frente a ellas estructuran la red y permiten detectar coaliciones discursivas. La distinción entre *justicia de mercado* y *justicia política* interpreta, en un nivel superior, los patrones formados por esas afirmaciones. Las estrategias de legitimación describen cómo se vuelve aceptable cada afirmación. Finalmente, la robustez ideacional se evalúa comparando la permanencia, la adaptación y la difusión de las afirmaciones a través del tiempo.
...
2. Conceptos: representación abstracta de los conceptos en discusión. Se elaborará, de forma deductiva, un libro de códigos de conceptos a partir de las categorías CARIN y la evidencia discursiva nacional. Este se enriquecerá de forma iterativa a medida que se codifiquen las intervenciones.
...
*Resúmen de la estrategia de análisis* 
