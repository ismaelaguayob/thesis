...
* *H3a — Permanencia:* Durante la tramitación, el repertorio que legitima la capitalización individual conservará su cobertura entre los actores, un balance favorable de apoyo frente al rechazo y la fuerza de sus conexiones con otros conceptos.
...
El proceso transformará las sesiones en intervenciones y, luego, en declaraciones y fragmentos justificativos. Debido al volumen del corpus, un LLM asistirá la aplicación de un libro de códigos definido teóricamente, pero la interpretación sustantiva permanecerá bajo responsabilidad del investigador. Primero se identificarán los conceptos y las posiciones de acuerdo o desacuerdo que formarán la red; después se segmentarán las justificaciones y se asignará una única estrategia de legitimación a cada fragmento. En ambos pasos el modelo deberá aportar evidencia textual y derivará los casos ambiguos o no cubiertos por el instrumento a revisión manual, en lugar de crear categorías por sí mismo (Ashwin et al., 2025; Dunivin, 2025).

La calidad de la codificación se evaluará con una muestra manual estratificada por cámara, tipo de instancia, etapa legislativa, partido, género y tipo de actor (Bosley, 2025). Una parte de esta muestra se utilizará para ajustar el libro de códigos y las instrucciones, y otra se reservará para la evaluación final. Se informarán precisión, sensibilidad, puntaje F1 y kappa de Cohen por tarea: extracción de conceptos, posición, segmentación de justificaciones y estrategia de legitimación. Si una categoría no alcanza un desempeño suficiente, se revisará el instrumento y se repetirá su evaluación antes de escalar el procesamiento (Crupi et al., 2025; Dunivin, 2025). De esta manera, el modelo funciona como asistente de clasificación y no como sustituto de la validación humana.
...
El análisis de los datos codificados se estructurará en fases metodológicas secuenciales y complementarias: una aproximación descriptiva de redes para caracterizar las coaliciones y las concepciones de justicia social empleadas (H1), modelos estadísticos a nivel de fragmento justificativo para evaluar la asociación entre coaliciones y estrategias de legitimación (H2), y un análisis temporal de la red y sus conceptos para examinar la permanencia, difusión y adaptación postuladas en H3.

Para evaluar la estructura macro del debate y responder a la primera hipótesis, la red bipartita original (actores-conceptos) se transformará en una red de congruencia entre actores. Para cada actor y concepto se agregará el balance de sus posiciones positivas y negativas dentro de cada etapa. La semejanza entre dos actores aumentará cuando sostengan orientaciones coincidentes y disminuirá cuando utilicen el mismo concepto con sentidos opuestos. Así, conceptos muy frecuentes, como la capitalización individual, no producirán cercanía por su sola presencia. La semejanza también se normalizará por la actividad de los actores, evitando que quienes intervienen más veces aparezcan artificialmente como más conectados.

Sobre esta red firmada se aplicará un procedimiento de detección de comunidades apto para relaciones positivas y negativas (*signed spin-glass*), siguiendo aplicaciones previas del DNA que identifican coaliciones a partir de la congruencia y el conflicto entre actores (Leifeld & Haunss, 2012; Schaub, 2021). Esto permitirá evaluar si la expectativa de dos polos se expresa en los datos y caracterizar el repertorio conceptual distintivo de cada uno. La centralidad de intermediación, o *betweenness centrality* (Freeman, 1977), se utilizará para evaluar si los actores de centroizquierda conectan ambos polos. En la red de conceptos, las medidas centrales serán la cobertura de actores y la fuerza de sus conexiones.

Una vez identificadas las coaliciones, se analizarán sus estrategias de legitimación. Esta secuencia separa las posiciones sustantivas que constituyen las coaliciones del modo en que cada grupo las presenta como aceptables, como se ha hecho en estudios que combinan DNA y estrategias narrativas (Schaub, 2021). La unidad del modelo será el fragmento justificativo y la variable dependiente será la estrategia asignada. Se estimará un modelo logístico multinomial multinivel, cuyos principales predictores serán la coalición discursiva, la filiación partidaria, el tipo de actor y la etapa legislativa. Dado que un mismo actor produce múltiples fragmentos en distintas sesiones y que cada sesión reúne a varios actores, se incorporarán interceptos aleatorios cruzados para actor y sesión (Tranmer et al., 2014). Esta especificación permitirá distinguir las tendencias argumentativas persistentes de los actores de los contextos compartidos dentro de cada sesión. El mismo modelo permitirá contrastar H2 o, si se reformula, responder la pregunta específica sobre la asociación entre coaliciones y estrategias.

Finalmente, H3 se evaluará mediante tres dimensiones separadas de la robustez ideacional —permanencia, difusión y adaptación—, sin agregarlas en un índice único. La dimensión temporal se incorporará mediante etapas legislativas e hitos sustantivos del proceso de tramitación.

La **permanencia** se observará mediante la proporción de actores activos que se refieren a cada concepto, el balance de sus posturas positivas y negativas y la fuerza de sus conexiones con otros conceptos en cada etapa (Leifeld, 2017; Leifeld & Haunss, 2012). Estas medidas permitirán distinguir la simple presencia de una idea de su apoyo y de su integración en un repertorio argumental.

La **difusión** utilizará como punto de partida las coaliciones identificadas en la primera etapa. El repertorio de preservación combinará un núcleo definido teóricamente —capitalización y propiedad individual, correspondencia contributiva y sostenibilidad financiera— con los conceptos-postura que distingan empíricamente a esa coalición al comienzo del proceso. Se mantendrá fija la pertenencia inicial de los actores para seguir su trayectoria. La difusión se observará en la proporción de actores de la coalición transformadora inicial que posteriormente adopten ese repertorio, en el aumento de la semejanza entre ambos polos y en la diversidad partidaria y organizacional alcanzada por esas ideas, siguiendo estudios que rastrean longitudinalmente la migración de actores y creencias entre coaliciones (Leifeld, 2013). Los conceptos que ya sean compartidos en la primera etapa se interpretarán como evidencia de alcance transversal previo, no como difusión ocurrida durante la tramitación. Este procedimiento evita crear una clasificación manual adicional de actores reformistas y permite observar la circulación de conceptos de una coalición a otra.

La **adaptación** se medirá preservando el vínculo entre declaraciones unitarias provenientes de una misma intervención o unidad textual. Se examinará si aumenta la combinación de solidaridad positiva con restricciones contributivas, focalizadas o financieras, así como el número y la diversidad de conceptos-postura articulados con ella. Este seguimiento de combinaciones permite observar cómo los repertorios de una coalición responden a los cambios del debate (Schaub, 2021). Los conceptos se mantendrán como unidades independientes y el libro de códigos permanecerá abierto a categorías inductivas recurrentes. La revisión cualitativa de las declaraciones que sostienen las conexiones más importantes permitirá comprobar que la coocurrencia expresa un condicionamiento sustantivo y no sólo proximidad textual. El desplazamiento de las ideas asociadas a la capitalización, su concentración exclusiva en el polo de preservación o la expansión transversal de argumentos solidarios no condicionados se interpretarán como evidencia contraria a H3. La persistencia institucional del sistema se mantendrá como contexto del caso y no será modelada como un resultado atribuible a las ideas.
